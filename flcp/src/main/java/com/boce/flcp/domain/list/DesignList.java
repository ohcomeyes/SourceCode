 ...
 * @version V1.0
 * @Package com.boce.flcp.domain.list
 * @Description: TODO(设计列表)
 * @date 2017/12/6 15:27
 */
@ApiModel(value = "DesignList",description = "产品列表")
public class DesignList {
    ...
    @ApiModelProperty(value = "中标时间",position = 11)
    private String demand_bid_winner_time;
    @ApiModelProperty(value = "需求状态#bid:待设计,audit:待审核,reject:已驳回",position = 12)
    private String demand_status;
    @ApiModelProperty(value = "需求创建时间",position = 13)
    ...
    public DesignList(Long id, String demand_id, String demand_name, String demand_employer,String phone,String demand_type, BigDecimal demand_money, String demand_describe, String classify_type, Long demand_bid_winner, String demand_bid_winner_name,String demand_bid_winner_time, String demand_status, String demand_time, boolean demand_making_send) {
        super();
        this.id = id;
