...
(function (z) {
    ...
    function Qc(a, b) {
        ...
        var e = {}, g = /^\s*directive:\s*([\w-]+)\s+(.*)$/, h = /(([\w-]+)(?::([^;]+))?;?)/,
            k = me("ngSrc,ngSrcset,src,srcset"), l = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/,
    ...
    function xf() {
        this.$get = ["$rootScope", "$window", "$q", "$$q", "$browser", function (a, b, d, c, f) {
            function e(e, k, l, m) {
                ...
                var p = 4 < arguments.length, r = p ? wa.call(arguments, 4) : [], J = b.setInterval,
                    q = b.clearInterval,
    ...
    function Ef() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function (d, c, f, e, g) {
            ...
            d.$watch(function () {
                var a = mb(c.url()), b = mb(l.absUrl()), e = c.state(), g = l.$$replace,
    ...
    function Mf() {
        this.$get = ["$window", "$document", function (a, b) {
            var d = {},
                ...
                f = Z((/android (\d+)/.exec(P((a.navigator ||
                    {}).userAgent)) || [])[1]), e = /Boxee/i.test((a.navigator || {}).userAgent), g = b[0] || {},
        ...
        return ["$parse", function (g) {
            return {
                restrict: "AC", link: function (h,
                    ...
                    function r(a) {
                        if (w === b) {
                            var c = t && t.split(" "), e = a && a.split(" "), f = d(c, e), c = d(e, c), f = m(f, -1),
                                c = m(c, 1);
                            l.$addClass(c);
                            l.$removeClass(f)
                        }
                    ...
                    var s = l[a].trim(), v = ":" === s.charAt(0) && ":" === s.charAt(1), s = g(s, v ? f : c),
    ...
    var Ng = /^\/(.+)\/([a-z]*)$/, va = Object.prototype.hasOwnProperty,
        ...
        }, La, D, oa, wa = [].slice, ng = [].splice, Og = [].push, na = Object.prototype.toString,
        Gc = Object.getPrototypeOf, Ga = M("ng"), $ = z.angular || (z.angular = {}), Zb, rb = 0;
    ...
    var Wf = /-([a-z])/g, Pg = /^-ms-/, Ab = {mouseleave: "mouseout", mouseenter: "mouseover"}, ac = M("jqLite"),
        Zf = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, $b = /<|&#?\w+;/, Xf = /<([\w:-]+)/,
        Yf = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, ha = {
    ...
    var Uf = [function () {
        ...
        hg = /^[^(]*\(\s*([^)]*)\)/m, Qg = /,/, Rg = /^\s*(_?)(\S+?)\1\s*$/, fg = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg,
        da = M("$injector");
    ...
    var gd = /^((?:x|data)[:\-_])/i, mg = /[:\-_]+(.)/g, nd = M("$controller"),
        ...
        }, od = "application/json", kc = {"Content-Type": od + ";charset=utf-8"}, pg = /^\[|^\{(?!\{)/,
    ...
    var Df = function () {
        ...
        }, Sg = /^([^?#]*)(\?([^#]*))?(#(.*))?$/, sg = {http: 80, https: 443, ftp: 21}, lb = M("$location"),
        tg = /^\s*[\\/]{2,}/, Tg = {
            $$absUrl: "",
    ...
    var ua = M("$sce"), pa = {HTML: "html", CSS: "css", URL: "url", RESOURCE_URL: "resourceUrl", JS: "js"},
    ...
    var ce = function (a) {
        ...
        Ne = ce(!0), Kg = /^\d{4,}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+(?:[+-][0-2]\d:[0-5]\d|Z)$/,
        ...
        Lg = /^\s*(-|\+)?(\d+|(\d*(\.\d*)))([eE][+-]?\d+)?\s*$/, de = /^(\d{4,})-(\d{2})-(\d{2})$/,
    ...
    var ff = function () {
        ...
        }, Se = Ra({terminal: !0, priority: 1E3}), $g = M("ngOptions"),
        ...
        $e = ["$compile", "$document", "$parse", function (a, b, d) {
            function c(a, b, c) {
                ...
                var v = a && d(a) || b, u = s && d(s), w = s ? function (a, b) {
                    ...
                    x = function (a, b) {
                        return w(a, B(a, b))
                    }, t = d(n[2] || n[1]), z = d(n[3] || ""), A = d(n[4] || ""), K = d(n[8]), I = {},
                    B = q ? function (a, b) {
                        I[q] = b;
                        I[p] = a;
                        return I
                ...
                return {
                    trackBy: s, getTrackByValue: x, getWatchables: d(K, function (a) {
                        ...
                        for (var a = [], b = {}, d = K(c) || [], g = f(d), h = g.length, n = 0; n < h; n++) {
                            var p = d ===
                                g ? n : g[n], q = B(d[p], p), r = v(c, q), p = w(r, q), u = t(c, q), I = z(c, q),
                                q = A(c, q), r = new e(p, r, u, I, q);
                            a.push(r);
                            b[p] = r
                        }
                        return {
            ...
            return {
                link: function (e, g, h) {
                    ...
                    var l = h.count, m = h.$attr.when && g.attr(h.$attr.when), n = h.offset || 0, p = e.$eval(m) || {},
                        r = {}, s = b.startSymbol(), v = b.endSymbol(), u = s + l + "-" + n + v, H = $.noop, y;
                    q(h, function (a, b) {
                        var c = f.exec(b);
