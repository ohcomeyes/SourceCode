...
(function (i, za, p) {
    ...
    n.oPagination = {
        two_button: {
            ...
            fnInit: function (g, l, s) {
                var t = p.createElement("span"), w = p.createElement("span"), y = p.createElement("span"),
                    F = p.createElement("span"), x = p.createElement("span");
                ...
                // alert("fnUpdate:213");
                if (g.aanFeatures.p) {
                    var s = n.oPagination.iFullNumbersShowPages, t = Math.floor(s / 2),
                        w = Math.ceil(g.fnRecordsDisplay() / g._iDisplayLength),
                        y = Math.ceil(g._iDisplayStart / g._iDisplayLength) + 1, F =
                            "", x, v = g.oClasses;
                    if (w < s) {
                        t = 1;
                        x = w
    ...
    i.fn.dataTable = function (g) {
        ...
        function l() {
            ...
            this.fnServerData = function (a, b, c, d) {
                alert("fnServerData:441-a:"+a+",b:"+b);
                d.jqXHR = i.ajax({
        ...
        function Ja(a) {
            ...
            var b = p.createElement("div"), c = p.createElement("div"), d = p.createElement("div"),
                ...
                j = a.nTable.cloneNode(false), k = a.nTable.cloneNode(false),
        ...
        function Ma(a) {
            var b = a.nScrollHead.getElementsByTagName("div")[0], c = b.getElementsByTagName("table")[0],
                d = a.nTable.parentNode, f, e, h, j, k, m, u, r, H = [],
        ...
        function Ra(a) {
            if (!(!a.oFeatures.bInfo || a.aanFeatures.i.length === 0)) {
                var b = a._iDisplayStart +
                    1, c = a.fnDisplayEnd(), d = a.fnRecordsTotal(), f = a.fnRecordsDisplay(), e = a.fnFormatNumber(b),
                    h = a.fnFormatNumber(c), j = a.fnFormatNumber(d), k = a.fnFormatNumber(f);
